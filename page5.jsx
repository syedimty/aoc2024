          ...
          {jobData.executionDetails.map((detail, index) => (
            <div key={index} className="flex items-start space-x-4 p-3 rounded-lg border border-gray-100">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-900 leading-relaxed">{detail.description}</p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium">{jobData.startTime}</span>
              <span className="text-gray-500">({jobData.frequency})</span>
            </div>
            <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-500">(45min ago)</span>
            </div>
            <div className="flex items-center space-x-2">
              <Activity className="h-4 w-4 text-blue-500" />
              <span className="text-gray-600">Status:</span>
              <StatusBadge status={jobData.status} size="sm" />
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">{jobData.longDescription}</p>
                </div>
              </div>
            </div>
            <div>
